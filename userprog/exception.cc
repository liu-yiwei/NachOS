...
ExceptionHandler(ExceptionType which)
{
	...
	/* Process Write Systemcall*///(char *buffer, int size, OpenFileId id);
	result = SysWrite(/* int op1 */(char*)kernel->machine->ReadRegister(4),
		/* int op2 */(int)kernel->machine->ReadRegister(5),
	...
	/* Process Read Systemcall*/
	int result;
	result = SysRead(/* int op1 */(char*)kernel->machine->ReadRegister(4),
			/* int op2 */(int)kernel->machine->ReadRegister(5),
			/* int op3 */(int)kernel->machine->ReadRegister(6));
	...
	/* Process Exec Systemcall*/
	result = SysExec(/* int op1 */(char*)kernel->machine->ReadRegister(4));
